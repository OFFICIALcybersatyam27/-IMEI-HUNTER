...
def banner():
  ...
  _____ __  __ ______ _____   _    _ _    _ _   _ _______ ______ _____
 |_   _|  \/  |  ____|_   _| | |  | | |  | | \ | |__   __|  ____|  __ \
   | | | \  / | |__    | |   | |__| | |  | |  \| |  | |  | |__  | |__) |
   | | | |\/| |  __|   | |   |  __  | |  | | . ` |  | |  |  __| |  _  /
  _| |_| |  | | |____ _| |_  | |  | | |__| | |\  |  | |  | |____| | \ \
 |_____|_|  |_|______|_____| |_|  |_|\____/|_| \_|  |_|  |______|_|  \_\
    ...
    """ + Style.RESET_ALL)
    print(Fore.YELLOW + "Created by OFFICIAL_cyber_satyam27" + Style.RESET_ALL)
    print(Fore.YELLOW + "Computer Science Student and Cybersecurity Enthusiast" + Style.RESET_ALL)
    print(Fore.YELLOW + "GitHub: https://github.com/OFFICIALcybersatyam27" + Style.RESET_ALL)
